...
let clientId ="client_id=079a71e2384f40c0ac696c11e9d1a47e"
let clientSecret="client_secret=4b2b872e4da54a8ba180c6900f2c0349"

let datosBody=grantType+'&'+clientId+'&'+clientSecret

//3. EJECUTE EL CONSUMO A TRAVES EDL FETCH
let peticion={
    method:"POST",
    headers:{
...
.then(function(respuesta){
    ...
    let urlcanciones="https://api.spotify.com/v1/artists/3AA28KZvwAUcZuOKwyblJQ/top-tracks?market=US"
    ...
    .then(function(respuesta){
        ...
        imagen1.src=respuesta.tracks[0].album.images[1].url
        ...
        imagen4.src=respuesta.tracks[3].album.images[1].url
        ...
        let audio5=document.getElementById("audio6")
        ...
        imagen7.src=respuesta.tracks[6].album.images[1].url
        ...
        imagen8.src=respuesta.tracks[7].album.images[1].url
        ...
        imagen9.src=respuesta.tracks[8].album.images[1].url
        ...
        imagen10.src=respuesta.tracks[9].album.images[1].url
